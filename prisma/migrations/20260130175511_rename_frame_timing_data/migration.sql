/*
  ...
  - You are about to drop the column `frameTimesData` on the `AggregatedProfile` table. All the data in the column will be lost.
  - Added the required column `frameTimingData` to the `AggregatedProfile` table without a default value. This is not possible if the table is not empty.
